...
function CounterTwo() {
    ...
    return (
        <div>
            ...
            <div>
                <button type='button' onClick={() => dispatch({ type: 'increment2', value: 1 })} >Increment</button>
                <button type='button' onClick={() => dispatch({ type: 'decrement2', value: 1 })} >Decrement</button>
            </div>
